...
void Lazik::Jedz(const double OdlegloscDoPrzejechania, const double szybkosc, PzG::LaczeDoGNUPlota Lacze)
{
  ...
  Wspol_koncowe[0]=sqrt(pow(OdlegloscDoPrzejechania,2)-pow(sin((this->WezKat()*PI)/180)*OdlegloscDoPrzejechania,2))*(cos(this->WezKat()*PI/180)/(abs(cos(this->WezKat()*PI/180))));
  Wspol_koncowe[1]=sqrt(pow(OdlegloscDoPrzejechania,2)-pow(cos((this->WezKat()*PI)/180)*OdlegloscDoPrzejechania,2))*(sin(this->WezKat()*PI/180)/(abs(sin(this->WezKat()*PI/180))));
 ...
 // cout << Wspol_koncowe << endl;
  for(double i=0;abs(i)<OdlegloscDoPrzejechania;i+=szybkosc)
  {
    usleep(10000);
